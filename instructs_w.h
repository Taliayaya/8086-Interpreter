...
typedef int (*W_Instruction)(uint8_t *, uint16_t, 
	uint8_t, uint8_t, uint8_t, uint8_t);

typedef int (*W_Instruction2)(uint8_t *, uint16_t, uint8_t, uint8_t);
...
int op_idiv(uint8_t *text_segment, uint16_t *pc, uint8_t op, uint8_t flag,
            uint8_t byte2, uint8_t w);

int op_not(uint8_t *text_segment, uint16_t *pc, uint8_t op, uint8_t flag,
           uint8_t byte2, uint8_t w);

int op_and_1(uint8_t *text_segment, uint16_t *pc, uint8_t op, uint8_t flag,
             uint8_t byte2, uint8_t w);

int op_xchg_0(uint8_t *text_segment, uint16_t *pc, uint8_t op, uint8_t flag,
              uint8_t byte2, uint8_t w);
